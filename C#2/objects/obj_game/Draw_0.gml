...
case rm_game: 
	...
	draw_text_transformed_colour(10, 30,"SCORE:" + string(score), 2, 2, 0, c, c, c, c, 1);
    break; 

case rm_result: 
    draw_set_halign(fa_center); 
    var c = c_orange; 
    draw_text_transformed_colour(room_width / 2, 250, "リザルト", 6, 6, 0, c, c, c, c, 1);
	draw_text_transformed_colour(room_width / 2, 400, string(score), 6, 6, 0, c, c, c, c, 1); 
	c=c_yellow; 
